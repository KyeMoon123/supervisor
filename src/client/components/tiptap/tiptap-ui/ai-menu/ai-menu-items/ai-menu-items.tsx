...
import {
  ...
  useAiMenuState,
} from "@/components/tiptap/tiptap-ui/ai-menu";
...
import {
  SUPPORTED_LANGUAGES,
  SUPPORTED_TONES,
} from "@/components/tiptap/tiptap-ui/ai-menu/ai-menu-items/ai-menu-items-constants";
import type {
  EditorMenuAction,
  ...
  NestedMenuAction,
} from "@/components/tiptap/tiptap-ui/ai-menu/ai-menu-items/ai-menu-items-types";

// -- Icons --
import { ChevronRightIcon } from "@/components/tiptap/tiptap-icons/chevron-right-icon";
import { SummarizeTextIcon } from "@/components/tiptap/tiptap-icons/summarize-text-icon";
import { Simplify2Icon } from "@/components/tiptap/tiptap-icons/simplify-2-icon";
import { LanguagesIcon } from "@/components/tiptap/tiptap-icons/languages-icon";
import { MicAiIcon } from "@/components/tiptap/tiptap-icons/mic-ai-icon";
import { TextExtendIcon } from "@/components/tiptap/tiptap-icons/text-extend-icon";
import { TextReduceIcon } from "@/components/tiptap/tiptap-icons/text-reduce-icon";
import { CompleteSentenceIcon } from "@/components/tiptap/tiptap-icons/complete-sentence-icon";
import { SmileAiIcon } from "@/components/tiptap/tiptap-icons/smile-ai-icon";
import { CheckAiIcon } from "@/components/tiptap/tiptap-icons/check-ai-icon";
