...
// --- Lib ---
import { isNodeTypeSelected } from "@/client/lib/tiptap-utils";
...
export function canExecuteUndoRedoAction(
  ...
  // Tiptap does not support editor.can().undo(), so we check if the command exists and editor is editable
  return action === "undo"
